...
void testCheckAtLeast(
  ...
  '$name asserts if value is not as expected',
  const [(5, false), (6, false), (100000, false), (4, true)],
  (fixture) {
    when(source).thenReturn(5);
...
void testCheckAtMost(
  ...
  '$name asserts if value is not as expected',
  const [(5, false), (4, false), (0, false), (6, true)],
  (fixture) {
    when(source).thenReturn(5);
...
void testCheckInRange(
  ...
  '$name asserts if value is not as expected',
  const [(5, false), (10, false), (15, false), (4, true), (16, true)],
  (fixture) {
