...
class AeadAegis256TestCase(super.runner) extends TestCase {
  @override
  ...
  void setupTests() {
    test('constants return correct values', (sodium) {
      final sut = sodium.crypto.aeadAegis256;

      expect(sut.keyBytes, 32, reason: 'keyBytes');
      expect(sut.nonceBytes, 32, reason: 'nonceBytes');
      expect(sut.aBytes, 32, reason: 'aBytes');
    });
