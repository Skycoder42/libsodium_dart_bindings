...
void main() {
  ...
  test('calls sodium_init', () async {
    ...
    await SodiumSumoInit.initFromSodiumFFI2(() => mockSodium);
  ...
  test('throws if sodium_init fails', () {
    ...
    expect(
      () async => SodiumSumoInit.initFromSodiumFFI2(() => mockSodium),
  ...
  test('returns SodiumFFI instance', () async {
    ...
    final sodium = await SodiumSumoInit.initFromSodiumFFI2(() => mockSodium);
    expect(
      sodium,
