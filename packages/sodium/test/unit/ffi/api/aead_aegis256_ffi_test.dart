...
void main() {
  ...
  setUp(() {
    ...
    sut = AeadAegis256FFI(mockSodium);
  });

  testConstantsMapping([
    (
      () => mockSodium.crypto_aead_aegis256_keybytes(),
      () => sut.keyBytes,
      'keyBytes',
    ),
    (
      () => mockSodium.crypto_aead_aegis256_npubbytes(),
      () => sut.nonceBytes,
      'nonceBytes',
    ),
    (
      () => mockSodium.crypto_aead_aegis256_abytes(),
      () => sut.aBytes,
      'aBytes',
    ),
  ]);
  ...
  group('methods', () {
    setUp(() {
      when(() => mockSodium.crypto_aead_aegis256_keybytes()).thenReturn(5);
      when(() => mockSodium.crypto_aead_aegis256_npubbytes()).thenReturn(5);
      when(() => mockSodium.crypto_aead_aegis256_abytes()).thenReturn(5);
    });

    testKeygen(
      mockSodium: mockSodium,
      runKeygen: () => sut.keygen(),
      keyBytesNative: mockSodium.crypto_aead_aegis256_keybytes,
      keygenNative: mockSodium.crypto_aead_aegis256_keygen,
    );
    ...
    group('encrypt', () {
      test('asserts if nonce is invalid', () {
        ...
        verify(() => mockSodium.crypto_aead_aegis256_npubbytes());
      });
      ...
      test('asserts if key is invalid', () {
        ...
        verify(() => mockSodium.crypto_aead_aegis256_keybytes());
      });

      test('calls crypto_aead_aegis256_encrypt with default '
          'arguments', () {
        when(
          () => mockSodium.crypto_aead_aegis256_encrypt(
            any(),
            any(),
            any(),
            any(),
      ...
      test('calls crypto_aead_aegis256_encrypt with additional '
          'data', () {
        when(
          () => mockSodium.crypto_aead_aegis256_encrypt(
            any(),
    ...
    group('decrypt', () {
      test('asserts if cipherText is invalid', () {
        ...
        verify(() => mockSodium.crypto_aead_aegis256_abytes());
      });
      ...
      test('calls crypto_aead_aegis256_decrypt with default '
          'arguments', () {
        when(
          () => mockSodium.crypto_aead_aegis256_decrypt(
            any(),
            any(),
            any(),
            any(),
      ...
      test('calls crypto_aead_aegis256_decrypt with additional '
          'data', () {
        when(
          () => mockSodium.crypto_aead_aegis256_decrypt(
            any(),
    ...
    group('encryptDetached', () {
      ...
      test('calls crypto_aead_aegis256_encrypt_detached with '
          'default arguments', () {
        when(
          () => mockSodium.crypto_aead_aegis256_encrypt_detached(
            any(),
            any(),
            any(),
            any(),
    ...
    group('decryptDetached', () {
      ...
      test('calls crypto_aead_aegis256_decrypt_detached with '
          'default arguments', () {
        when(
          () => mockSodium.crypto_aead_aegis256_decrypt_detached(
            any(),
            any(),
            any(),
            any(),
