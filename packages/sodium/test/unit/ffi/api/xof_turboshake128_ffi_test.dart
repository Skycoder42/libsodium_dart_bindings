...
import 'package:sodium/src/ffi/bindings/libsodium.ffi.dart'
    show crypto_xof_turboshake128_state;
...
void main() {
  ...
  setUp(() {
    ...
    sut = XofTurboshake128FFI(mockSodium);
  });
  ...
  group('methods', () {
    ...
    group('call', () {
      test('asserts if outLen is invalid', () {
        ...
        verifyNever(
          () => mockSodium.crypto_xof_turboshake128(any(), any(), any(), any()),
        );
      });
      ...
      test('throws if crypto_xof_turboshake128 fails', () {
        when(
          () => mockSodium.crypto_xof_turboshake128(any(), any(), any(), any()),
        ).thenReturn(1);
    ...
    group('createConsumer', () {
      test('asserts if domain is invalid', () {
        ...
        verifyNever(
          () => mockSodium.crypto_xof_turboshake128_init_with_domain(
            any(),
            any(),
          ),
        );
      ...
      test('creates a consumer that is initialized with '
        ...
        expect(result, isA<XofConsumerFFI<crypto_xof_turboshake128_state>>());
      ...
      test('creates a consumer that is initialized with '
        ...
        verifyNever(() => mockSodium.crypto_xof_turboshake128_init(any()));
      });
      ...
      test('creates a consumer that uses crypto_xof_turboshake128_update and '
        ...
        when(
          () =>
              mockSodium.crypto_xof_turboshake128_squeeze(any(), any(), any()),
        ).thenAnswer((i) {
        ...
        verifyInOrder([
          ...
          () => mockSodium.crypto_xof_turboshake128_squeeze(
            any(that: isNot(nullptr)),
            any(that: isNot(nullptr)),
            outLen,
          ),
