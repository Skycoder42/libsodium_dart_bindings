...
void main() {
  ...
  group('methods', () {
    setUp(() {
      ...
      when(() => mockSodium.crypto_ipcrypt_ndx_outputbytes()).thenReturn(24);
    });

    testKeygen(
      mockSodium: mockSodium,
      runKeygen: () => sut.keygen(),
      keyBytesNative: mockSodium.crypto_ipcrypt_ndx_keybytes,
    ...
    group('encrypt', () {
      ...
      test('calls crypto_ipcrypt_ndx_encrypt with correct arguments', () {
        when(
          () =>
              mockSodium.crypto_ipcrypt_ndx_encrypt(any(), any(), any(), any()),
        ).thenAnswer((_) {});
    ...
    group('decrypt', () {
      ...
      test('calls crypto_ipcrypt_ndx_decrypt with correct arguments', () {
        when(() => mockSodium.crypto_ipcrypt_ndx_decrypt(any(), any(), any()))
            .thenAnswer((_) {});
