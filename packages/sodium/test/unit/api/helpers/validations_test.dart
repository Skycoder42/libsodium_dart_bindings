...
void main() {
  testData<(int, int, int, bool)>(
    ...
    const [(5, 0, 10, false), (-5, 0, 10, true), (15, 0, 10, true)],
    (fixture) {
  ...
  testData<(int, int, bool)>(
    ...
    const [(5, 5, false), (-5, 5, true)],
    (fixture) {
      final matcher = throwsA(isA<RangeError>());
      expect(
        () =>
            Validations.checkIsSame(fixture.$1, fixture.$2, fixture.toString()),
  ...
  testData<(int, int, bool)>(
    ...
    const [(5, 5, false), (10, 5, false), (4, 5, true)],
    (fixture) {
      final matcher = throwsA(isA<RangeError>());
      expect(
