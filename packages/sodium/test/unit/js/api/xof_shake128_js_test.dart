...
void main() {
  ...
  setUp(() {
    ...
    sut = XofShake128JS(mockSodium.asLibSodiumJS);
  });
  ...
  // libsodium.js does not export crypto_xof_shake128_DOMAIN_STANDARD, so the
  ...
  group('methods', () {
    setUp(() {
      ...
      when(() => mockSodium.crypto_xof_shake128_STATEBYTES).thenReturn(5);
    });
    ...
    group('call', () {
      test('asserts if outLen is invalid', () {
        ...
        verifyNever(() => mockSodium.crypto_xof_shake128(any(), any()));
      });

      test('calls crypto_xof_shake128 with correct arguments', () {
        when(() => mockSodium.crypto_xof_shake128(any(), any()))
    ...
    group('createConsumer', () {
      ...
      test('creates a consumer that is initialized with '
        ...
        when(() => mockSodium.crypto_xof_shake128_init())
        ...
        expect(result, isA<XofConsumerJS<XofShake128State>>());
