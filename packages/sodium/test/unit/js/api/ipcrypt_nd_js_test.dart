...
void main() {
  ...
  setUp(() {
    reset(mockSodium);
    sut = IpcryptNdJS(mockSodium.asLibSodiumJS);
  });
  ...
  group('methods', () {
    ...
    group('encrypt', () {
      ...
      test('calls crypto_ipcrypt_nd_encrypt with correct arguments', () {
        when(() => mockSodium.crypto_ipcrypt_nd_encrypt(any(), any(), any()))
    ...
    group('decrypt', () {
      ...
      test('calls crypto_ipcrypt_nd_decrypt with correct arguments', () {
        when(() => mockSodium.crypto_ipcrypt_nd_decrypt(any(), any()))
            .thenReturn(Uint8List(0).toJS);
